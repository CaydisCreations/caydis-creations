...
async function updatePinkBagAllImages() {
  try {
    console.log('🔄 Updating "Handbag - Multicolor (Pink Bag - Flowers Lining)" with ALL images...\n');
    ...
    console.log('🎉 "Handbag - Multicolor (Pink Bag - Flowers Lining)" updated with ALL red/pink/orange/purple images!');
    console.log('\n📋 Summary:');
