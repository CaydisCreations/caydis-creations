...
const mediaItems: MediaItem[] = [
  ...
  {
    id: 'adult-cardigan-baby-blue',
    type: 'image-group',
    url: 'https://caydiscreations.s3.us-east-2.amazonaws.com/Public/Cardigan/blue_long_sleeve/IMG_6755.jpeg',
    images: [
    ...
    title: 'Adult Cardigan - Baby Blue',
    description: 'A nice stretchy cardigan for a nice night out. Oversized XL or XXL size in beautiful baby blue. Perfect for layering or wearing on its own.',
    categories: ['Clothing', 'Cardigans', 'Wearables'],
    tags: ['cardigan', 'baby blue', 'stretchy', 'oversized', 'clothing', 'wearables', 'handmade'],
    date: '2025-01-28',
  },
  {
    id: 'toddler-cardigan-baby-blue',
    type: 'image-group',
    url: 'https://caydiscreations.s3.us-east-2.amazonaws.com/Public/baby/Toddler_Cardigan_light_blue/IMG_6748.jpeg',
    images: [
    ...
    title: 'Toddler Cardigan - Baby Blue',
    description: 'A beautiful baby blue cardigan perfect for toddlers. Size: 18M-2T or 12-18 months old. Handmade with love and care.',
    categories: ['Baby Clothes', 'Cardigans', 'Clothing'],
    tags: ['toddler', 'cardigan', 'baby blue', 'baby clothes', 'clothing', 'handmade', '18M-2T'],
    date: '2025-01-28',
  },
  {
    id: 'baby-cardigan-baby-blue',
    type: 'image-group',
    url: 'https://caydiscreations.s3.us-east-2.amazonaws.com/Public/baby/baby_cardigan_light_blue/IMG_6742.jpeg',
    images: [
    ...
    title: 'Baby Cardigan - Baby Blue',
    description: 'A beautiful baby blue cardigan perfect for babies. Size: 3-6 months old. Handmade with love and care.',
    categories: ['Baby Clothes', 'Cardigans', 'Clothing'],
    tags: ['baby', 'cardigan', 'baby blue', 'baby clothes', 'clothing', 'handmade', '3-6 months'],
    date: '2025-01-28',
  },
]
